    ...
    <SafeAreaView className="flex-1 bg-transparent">
      <View className="flex-1 justify-end px-4 py-4">
        ...
        <View className="flex-row space-x-4 justify-between bg-background">
          ...
          >
            <View className="items-center justify-center">
              <Image source={require('@/assets/onboarding/easy-interface.svg')} className="w-[118] h-[155] bg-background opacity-50" />
            </View>
            
            <View className="flex-row items-center justify-center mt-4">
              <Text className="font-semibold text-xl text-muted-foreground">Easy</Text>
              <Text className="font-semibold text-sm text-muted-foreground ml-2">(Coming Soon)</Text>
            </View>
